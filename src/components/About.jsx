            ...
            <div className="about_me">
                <div className="about_me_top">
                    <div className="about_me_left">
                        ...
                        Моє захоплення ІТ почалося ще зі шкільних уроків по Scratch, вже у п’ятому класі я “програмував” різні програмки. У 15 років, я познайомився з HTML і CSS, відтоді програмування стало невід’ємною частиною мого життя. Зараз я впевнено працюю з React та різними js-бібліотеками, які допоможуть при подальшій розробці. Також маю досвід розробки fullstack-сайтів. Наразі я не просто вмотивований – я горю бажанням застосувати свої знання на практиці, брати участь у реальному проєкті і розвиватися щодня. Я повністю готовий вкладати максимум зусиль у свій розвиток і результат команди.
                        Взявши КТ у Олексія Татарчинського та в тебе, я повністю ознайомлений зі своїми обов’язками і готовий діяти. 
                        <br></br> <br></br>Потрапивши в BEST, я зрозумів наскільки великі можливості саморозвитку відкриваються кожному. У першу чергу я прагну організувати бездоганний BEC. І звісно бажаю внести свій слід у розвиток ІТ-напряму BEST’у. Також завжди готовий підтримати кортіму, допомагати у їхніх тасках. Для мене важливий справжній командний дух – я ціную комунікацію і щиро прагну створювати навколо себе вайбову, підтримуючу атмосферу. Маю велике бажання працювати над чимось справді важливим, чимось більшим, ніж просто лабораторні роботи з програмування.
                        </p>
                    </div>
                ...
                <div className="about_me_bottom">
                    ...
                    <ul className="bottom_pros">
                        ...
                        <div className={`bottom_pro ${isVisible4 ? 'fade-in' : ''}`} ref={prosRef4}>
                            <img className="bottom_pro_img" src="images/BEClogo1.svg" alt="logoBec" />
                            <li className="bottom_pros_text">
                            Flexibility. Відкритий до нових знайомств, легко підтримую діалог на будь-які теми. Мені приємно працювати з людьми, обмінюватися ідеями та разом працювати над досягненням спільних цілей.
                            </li>
                        </div>
                    </ul> 
                </div>
